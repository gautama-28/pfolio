...
const ProjectDetails = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full backdrop-blur-sm bg-black/30" onMouseDown={(e) => e.target === e.currentTarget && closeModal()}
>
      <motion.div
