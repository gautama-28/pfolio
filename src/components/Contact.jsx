...
function MyPage() {
  ...
  return (
    ...
    <div>
      ...
      <FlipLink href="https://www.linkedin.com/in/shivam-gautam-b20220295" icon={<LinkedinIcon />}>
        Linkedin
      </FlipLink>
      <FlipLink href="https://github.com/gautama-28" icon={<GithubIcon />}>
        Github
      </FlipLink>
      <FlipLink href="mailto:shivamgautama82@gmail.com" icon={<GmailIcon />}>
        Gmail
      </FlipLink>
